...
public class ProductController {
	...
	public String insertProduct(@ModelAttribute("product")Product product,@RequestParam("pimage")MultipartFile filedet, Model m)
	{
		...
		String path="D:\\cartproj1\\frontendproj\\src\\main\\webapp\\resources\\images\\";
	...
	// Inserting New data
		...
		{
			System.out.println("\n Once you click the edit button, it will automatically delete the image for the particular product.");
